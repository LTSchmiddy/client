...
function isInBrowser() {
  inBrowser = (window.cordova && (window.cordova.platformId === 'electron' || window.cordova.platformId === 'browser' || window.cordova.platformId === 'osx')) || !(window.phonegap || window.cordova);
  return inBrowser;
}
